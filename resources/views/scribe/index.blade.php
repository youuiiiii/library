...
Must be one of:
<ul style="list-style-type: square;"><li><code>admin</code></li> <li><code>editor</code></li> <li><code>viewer</code></li></ul>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "author=consequatur"\
    --form "year=17"\
    --form "cover=@C:\Users\Legion\AppData\Local\Temp\php6AE3.tmp" </code></pre></div>
...
body.append('author', 'consequatur');
body.append('year', '17');
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="year"                data-endpoint="POSTapi-books"
               value="17"
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="cover"                data-endpoint="POSTapi-books"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\Legion\AppData\Local\Temp\php6AE3.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "author=amniihfqcoynlazghdtqt"\
    --form "description=Dolores dolorum amet iste laborum eius est dolor."\
    --form "cover=@C:\Users\Legion\AppData\Local\Temp\php6B03.tmp" </code></pre></div>
...
body.append('author', 'amniihfqcoynlazghdtqt');
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="year"                data-endpoint="PUTapi-books--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="cover"                data-endpoint="PUTapi-books--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\Legion\AppData\Local\Temp\php6B03.tmp</code></p>
        </div>
        </form>
